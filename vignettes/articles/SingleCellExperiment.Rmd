...
Canek accepts either a list of `SingleCellExperiments` objects or single objects with a `batch` identifier. We can pass a vector of variable features to use in the integration.
