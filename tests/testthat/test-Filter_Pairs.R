...
test_that("Filter_Pairs works", {
  ...
  expect_equal(dim(M2_Pairs_Data$`Selected Pairs`), c(337,2))
  expect_equal(dim(M3_Pairs_Data$`Selected Pairs`), c(537,2))

  expect_true( (M2_Pairs_Data$`Selected Cluster` == 2) && (M3_Pairs_Data$`Selected Cluster` == 2))
